...
// Popup video youtube
const sectionImage = document.querySelector('.section-video');
const main = document.querySelector('.main');
sectionImage.addEventListener('click', function () {
    const template = `<iframe width="560" height="315" src="https://www.youtube.com/embed/NjIkTXmPycY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
    ...
    shadow.appendChild(popupVideo);
    popupVideo.innerHTML = template;

    shadow.onclick = function () {
        main.removeChild(shadow)
        popupVideo.onclick = function (event) {
